...
load_weights(gen_1, None, "weights/model_weights_gen_1648800442.1690753.pth", None)
load_weights(gen_2, None, "weights/model_weights_gen_2_1648821286.7622628.pth", None)
gen_1.eval()
gen_2.eval()
